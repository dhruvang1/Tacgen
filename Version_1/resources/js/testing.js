function convert_to_unicode(krutidev_string)
{
...
var modified_substring = krutidev_string  ;

    var text_size = krutidev_string.length ;
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     { 
      ...
      while (krutidev_string.charAt ( sthiti2 ) != ' ') {sthiti2--;}
     } 
     else  { sthiti2 = text_size  ;  chale_chalo = 0 }

     var modified_substring = krutidev_string.substring ( sthiti1, sthiti2 )  ;
...
function Convert_to_Kritidev_010(unicode_string)
{
...
var modified_substring = unicode_string  ;

//****************************************************************************************
//  Break the long text into small bunches of max. max_text_size  characters each.
//****************************************************************************************
    var text_size = unicode_string.length ;
   ...
   //************************************************************
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     { 
      sthiti2 +=  max_text_size ;
      while (unicode_string.charAt ( sthiti2 ) != ' ') {sthiti2--;}
     } 
     else  { sthiti2 = text_size  ;  chale_chalo = 0 }

     var modified_substring = unicode_string.substring ( sthiti1, sthiti2 )  ;
